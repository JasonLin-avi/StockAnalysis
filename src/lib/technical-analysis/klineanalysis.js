 ...
 * 
 * Uses 'technicalindicators' library to compute SMA, RSI, and MACD indicators,
...
function generateLLMTechnicalSummary(rawData) {
    ...
    // 1. 確保數據有效 (至少需要 30 筆資料來計算 20MA 及 MACD)
