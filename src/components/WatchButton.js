...
import { getWatchlist, addWatch, removeWatch } from '../lib/watchlist-store';
...
export default function WatchButton({ symbol }) {
  ...
  return (
    ...
    >
      <svg aria-hidden="true" className="w-6 h-6" fill={isWatched ? "currentColor" : "none"} stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
