          ...
          {!evaluation ? (
            <div className="text-center py-10 px-4">
              ...
              <button
                onClick={onReveal}
                disabled={evaluating}
                className="bg-emerald-600 hover:bg-emerald-500 text-white font-medium px-6 py-2.5 rounded-lg text-sm shadow-md hover:shadow-emerald-500/20 transition-all disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer flex items-center justify-center gap-2 mx-auto"
              >
                {evaluating ? (
                  <>
